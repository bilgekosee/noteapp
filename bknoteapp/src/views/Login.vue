...
<template>
  <main>
    <h1 class="text-4xl font-bold mb-8">Bilge's Notes App</h1>
    ...
    <form @submit.prevent="registerOrLogin">
      ...
      <label class="block mb-4">
        ...
        <input
          ...
          v-model="email"
          class="block w-full text-slate-900 px-4 py-2"
        />
      </label>
      ...
      <input
        ...
        class="text-green-800 hover:underline mb-4 cursor-pointer"
      />
